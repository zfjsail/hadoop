...
public class TriangleCounter extends Configured implements Tool {
    ...
    public static class ToUndirectedMapper extends Mapper<LongWritable, Text, Text, LongWritable>
    {
                ...
                throws IOException, InterruptedException
        {
            ...
            if (tokenizer.hasMoreTokens()) {
                ...
                if (e1 < e2) {
                    mKey.set(Long.toString(e1) + "," + Long.toString(e2));
                    mValue.set(1);
                    context.write(mKey,mValue);
                }
                else if(e1 > e2) {
                    mKey.set(Long.toString(e2) + "," + Long.toString(e1));
                    mValue.set(-1);
                    context.write(mKey,mValue);
                }
            }
    ...
    public static class ToUndirectedReducer extends Reducer<Text, LongWritable, LongWritable, LongWritable>
    {
                ...
                throws IOException, InterruptedException
        {
            ...
            mKey.set(Long.parseLong(first));
            mValue.set(Long.parseLong(second));
            /*
            while (vs.hasNext()) {
                sum += vs.next().get();
            }
